...
DATA_DIR = os.getenv('PGADMIN_DATA_DIR')
if not DATA_DIR:
    if os.name == 'nt':
...
SERVER_MODE = to_bool(os.getenv('PGADMIN_SERVER_MODE', True))
...
# behind Apache HTTPD.
DEFAULT_SERVER = os.getenv('PGADMIN_SERVER_HOST', 'localhost')

# The default port on which the app server will listen if not set in the
# environment by the runtime
DEFAULT_SERVER_PORT = int(os.getenv('PGADMIN_SERVER_PORT', 5050))
